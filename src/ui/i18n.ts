...
const EN = {
  ...
  'archive.tabRating': 'RATING',
  'archive.tabAchievements': 'AWARDS',
  'archive.ratingLoading': 'LOADING',
  'archive.ratingOffline': 'The board is not answering. Your stars are safe — they are kept on this device too.',
  'archive.ratingNoServer': 'This build has no board behind it.',
  'archive.ratingEmpty': 'Nobody has finished a match yet. Be first.',
  'archive.ratingOnlyInTelegram': 'Open the game in Telegram and your own matches will count.',
  'archive.ratingStars': 'STARS',
  'archive.ratingMatches': 'MATCHES',
  'archive.ratingHeader': 'STARS EARNED',
...
const RU: Record<Key, string> = {
  ...
  'archive.tabRating': 'РЕЙТИНГ',
  'archive.tabAchievements': 'НАГРАДЫ',
  'archive.ratingLoading': 'ЗАГРУЖАЕМ',
  'archive.ratingOffline': 'Таблица не отвечает. Звёзды не потеряны — они хранятся и на этом устройстве.',
  'archive.ratingNoServer': 'В этой сборке таблицы нет.',
  'archive.ratingEmpty': 'Никто ещё не доиграл ни одного матча. Будь первым.',
  'archive.ratingOnlyInTelegram': 'Открой игру в Telegram, и твои матчи начнут считаться.',
  'archive.ratingStars': 'ЗВЁЗД',
  'archive.ratingMatches': 'МАТЧЕЙ',
  'archive.ratingHeader': 'ЗВЁЗД ЗАРАБОТАНО',
