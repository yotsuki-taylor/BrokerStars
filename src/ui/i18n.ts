...
const EN = {
  ...
  'archive.ratingSoon': 'Where you stand against everybody else. It needs a server, and there is not one yet.',
...
const RU: Record<Key, string> = {
  ...
  'archive.ratingSoon': 'Где ты среди всех остальных. Нужен сервер, а его пока нет.',
